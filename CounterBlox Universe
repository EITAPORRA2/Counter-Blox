...
------------------------------------ REPO ------------------------------------
local repo = 'https://raw.githubusercontent.com/EITAPORRA2/Counter-Blox/main/'
------------------------------------ LINKS ------------------------------------
...
ThemeManager:SetFolder('UniverseHub')
SaveManager:SetFolder('UniverseHub/main')
...
OthersSettings:AddInput('uinamechange', {Default = 'UniverseHub', Numeric = false, Finished = false, Text = 'Window Title', Tooltip = 'Changes window title', Placeholder = '. . .'})
...
Library:Notify('Finished Loading! Welcome ' ..localPlayer.Name.. ' to UniverseHub!');
